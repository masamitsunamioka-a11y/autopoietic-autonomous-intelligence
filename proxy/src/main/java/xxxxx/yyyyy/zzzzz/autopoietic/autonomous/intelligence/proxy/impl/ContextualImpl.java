...
public class ContextualImpl<T> implements Contextual<T> {
    private static final Logger logger = LoggerFactory.getLogger(ContextualImpl.class);
    private final AnnotatedType<T> annotatedType;
    private final ProxyContainer proxyContainer;

    public ContextualImpl(AnnotatedType<T> annotatedType,
    ...
    public T create(CreationalContext<T> creationalContext) {
        var unwrapped = (AnnotatedTypeImpl<T>) this.annotatedType;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ContextualImpl<?> that)) {
            return false;
        }
